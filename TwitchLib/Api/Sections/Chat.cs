...
namespace TwitchLib
{
    public class Chat
    {
        ...
        public class V3 : ApiSection
        {
            ...
            public async Task<Models.API.v3.Chat.EmoticonSetsResponse> GetEmoticonsBySetsAsync(IEnumerable<int> emotesets)
            {
        ...
        public class V5 : ApiSection
        {
            ...
            public async Task<Models.API.v5.Chat.ChannelBadges> GetChatBadgesByChannelAsync(string channelId)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Chat.ChannelBadges>($"https://api.twitch.tv/kraken/chat/{channelId}/badges").ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Chat.EmoteSet> GetChatEmoticonsBySetAsync(List<int> emotesets = null)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Chat.EmoteSet>("https://api.twitch.tv/kraken/chat/emoticon_images", getParams).ConfigureAwait(false);
            }
            #endregion
            #region GetAllChatEmoticons
            public async Task<Models.API.v5.Chat.AllChatEmotes> GetAllChatEmoticonsAsync()
            {
                return await Api.GetGenericAsync<Models.API.v5.Chat.AllChatEmotes>("https://api.twitch.tv/kraken/chat/emoticons").ConfigureAwait(false);
            }
            #endregion
        }
    }
