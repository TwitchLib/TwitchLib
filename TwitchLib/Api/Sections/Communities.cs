    ...
    public class Communities
    {
        ...
        public class V5 : ApiSection
        {
            ...
            public async Task<Models.API.v5.Communities.Community> GetCommunityByNameAsync(string communityName)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Communities.Community>("https://api.twitch.tv/kraken/communities", getParams).ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Communities.Community> GetCommunityByIDAsync(string communityId)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Communities.Community>($"https://api.twitch.tv/kraken/communities/{communityId}").ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Communities.TopCommunities> GetTopCommunitiesAsync(long? limit = null, string cursor = null)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Communities.TopCommunities>("https://api.twitch.tv/kraken/communities/top", getParams).ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Communities.BannedUsers> GetCommunityBannedUsersAsync(string communityId, long? limit = null, string cursor = null, string authToken = null)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Communities.BannedUsers>($"https://api.twitch.tv/kraken/communities/{communityId}/bans", getParams, authToken).ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Communities.Moderators> GetCommunityModeratorsAsync(string communityId, string authToken)
            {
                Api.Settings.DynamicScopeValidation(AuthScopes.Communities_Edit, authToken);
                if (string.IsNullOrWhiteSpace(communityId)) { throw new Exceptions.API.BadParameterException("The community id is not valid. It is not allowed to be null, empty or filled with whitespaces."); }
                return await Api.GetGenericAsync<Models.API.v5.Communities.Moderators>($"https://api.twitch.tv/kraken/communities/{communityId}/moderators", null, authToken).ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Communities.TimedOutUsers> GetCommunityTimedOutUsersAsync(string communityId, long? limit = null, string cursor = null, string authToken = null)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Communities.TimedOutUsers>($"https://api.twitch.tv/kraken/communities/{communityId}/timeouts", getParams, authToken).ConfigureAwait(false);
            }
            #endregion
