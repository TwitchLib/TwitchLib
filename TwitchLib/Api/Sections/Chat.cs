namespace TwitchLib
{
    ...
    public class Chat
    {
        ...
        public class V3 : ApiSection
        {
            ...
            {
                return await Api.GetGenericAsync<Models.API.v3.Chat.BadgesResponse>($"https://api.twitch.tv/kraken/chat/{channel}/badges", null, ApiVersion.v3).ConfigureAwait(false);
            }
            #endregion
            #region GetAllEmoticons
            public async Task<Models.API.v3.Chat.AllEmoticonsResponse> GetAllEmoticonsAsync()
            {
                return await Api.GetGenericAsync<Models.API.v3.Chat.AllEmoticonsResponse>("https://api.twitch.tv/kraken/chat/emoticons", null, ApiVersion.v3).ConfigureAwait(false);
            }
            #endregion
            ...
            {
                return await Api.GetGenericAsync<Models.API.v3.Chat.EmoticonSetsResponse>($"https://api.twitch.tv/kraken/chat/emoticon_images?emotesets={string.Join(",", emotesets)}", null, ApiVersion.v3).ConfigureAwait(false);
            }
            #endregion
        }
        ...
        public class V5 : ApiSection
        {
            ...
            public async Task<Models.API.v5.Chat.ChannelBadges> GetChatBadgesByChannelAsync(string channelId)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Chat.ChannelBadges>($"https://api.twitch.tv/kraken/chat/{channelId}/badges", null, ApiVersion.v5).ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Chat.EmoteSet> GetChatEmoticonsBySetAsync(List<int> emotesets = null)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Chat.EmoteSet>($"https://api.twitch.tv/kraken/chat/emoticon_images{payload}", null, ApiVersion.v5).ConfigureAwait(false);
            }
            #endregion
            #region GetAllChatEmoticons
            public async Task<Models.API.v5.Chat.AllChatEmotes> GetAllChatEmoticonsAsync()
            {
                return await Api.GetGenericAsync<Models.API.v5.Chat.AllChatEmotes>("https://api.twitch.tv/kraken/chat/emoticons", null, ApiVersion.v5).ConfigureAwait(false);
            }
            #endregion
        }
    }
