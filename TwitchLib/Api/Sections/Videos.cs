...
using TwitchLib.Extensions.System;
...
namespace TwitchLib
{
    public class Videos
    {
        ...
        public class V3 : ApiSection
        {
            ...
            #endregion
            #region GetTopVideos
            public async Task<Models.API.v3.Videos.TopVideosResponse> GetTopVideosAsync(int limit = 25, int offset = 0, string game = null, Period period = Period.Week)
            {
        ...
        public class V5 : ApiSection
        {
            ...
            public async Task<Models.API.v5.Videos.Video> GetVideoAsync(string videoId)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Videos.Video>($"https://api.twitch.tv/kraken/videos/{videoId}").ConfigureAwait(false);
            }
            #endregion
            #region GetTopVideos
            public async Task<Models.API.v5.Videos.TopVideos> GetTopVideosAsync(int? limit = null, int? offset = null, string game = null, string period = null, List<string> broadcastType = null, List<string> language = null, string sort = null)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Videos.TopVideos>("https://api.twitch.tv/kraken/videos/top", getParams).ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Videos.FollowedVideos> GetFollowedVideosAsync(int? limit = null, int? offset = null, List<string> broadcastType = null, List<string> language = null, string sort = null, string authToken = null)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Videos.FollowedVideos>("https://api.twitch.tv/kraken/videos/followed", getParams, authToken).ConfigureAwait(false);
            }
            #endregion
            #region UploadVideo
            public async Task<Models.API.v5.UploadVideo.UploadedVideo> UploadVideoAsync(string channelId, string videoPath, string title, string description, string game, string language = "en", string tagList = "", Viewable viewable = Viewable.Public, DateTime? viewableAt = null, string accessToken = null)
            {
            ...
            public async Task<Models.API.v5.Videos.Video> UpdateVideoAsync(string videoId, string description = null, string game = null, string language = null, string tagList = null, string title = null, string authToken = null)
            {
                ...
                return await Api.PutGenericAsync<Models.API.v5.Videos.Video>($"https://api.twitch.tv/kraken/videos/{videoId}", null, getParams, authToken).ConfigureAwait(false);
            }
            #endregion
            #region DeleteVideo
            ...
            private async Task<Models.API.v5.UploadVideo.UploadVideoListing> CreateVideoAsync(string channelId, string title, string description = null, string game = null, string language = "en", string tagList = "", Viewable viewable = Viewable.Public, DateTime? viewableAt = null, string accessToken = null)
            {
                var getParams = new List<KeyValuePair<string, string>>
                {
