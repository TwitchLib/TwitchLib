...
public class EventSubWebsocketClient
{
    ...
    public EventSubWebsocketClient(
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
    ...
    private async Task<bool> ReconnectAsync()
    {
        ...
        var reconnectClient = _serviceProvider.GetRequiredService<WebsocketClient>();
    ...
    {
        _handlers ??= new Dictionary<string, Action<EventSubWebsocketClient, string, JsonSerializerOptions>>();
    ...
    private void OnDataReceived(object? sender, DataReceivedArgs e)
    {
        ...
        switch (messageType)
        {
            ...
            case "notification":
                ...
                {
                    ErrorOccurred?.Invoke(this, new ErrorOccuredArgs { Exception = new NullReferenceException("subscriptionType"), Message = "Unable to determine subscription type!"});
                    break;
                }
