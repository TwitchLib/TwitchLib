...
namespace TwitchLib
{
    public class Users
    {
        ...
        public class V3 : ApiSection
        {
            ...
            public async Task<Models.API.v3.Users.FollowedStreamsResponse> GetFollowedStreamsAsync(int limit = 25, int offset = 0, StreamType type = StreamType.All, string accessToken = null)
            {
                Api.Settings.DynamicScopeValidation(AuthScopes.User_Read, accessToken);
            ...
            public async Task<Models.API.v3.Users.FollowedVideosResponse> GetFollowedVideosAsync(int limit = 25, int offset = 0, BroadcastType broadcastType = BroadcastType.All, string accessToken = null)
            {
                Api.Settings.DynamicScopeValidation(AuthScopes.User_Read, accessToken);
                var getParams = new List<KeyValuePair<string, string>>
                {
        ...
        public class V5 : ApiSection
        {
            ...
            public async Task<Models.API.v5.Users.Users> GetUsersByNameAsync(List<string> usernames)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Users.Users>("https://api.twitch.tv/kraken/users", getParams).ConfigureAwait(false);
            }
            #endregion
            #region GetUser
            public async Task<Models.API.v5.Users.UserAuthed> GetUserAsync(string authToken = null)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Users.UserAuthed>("https://api.twitch.tv/kraken/user", null, authToken).ConfigureAwait(false);
            }
            #endregion
            #region GetUserByID
            public async Task<Models.API.v5.Users.User> GetUserByIDAsync(string userId)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Users.User>($"https://api.twitch.tv/kraken/users/{userId}").ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Users.UserEmotes> GetUserEmotesAsync(string userId, string authToken = null)
            {
                ...
                if (string.IsNullOrWhiteSpace(userId)) { throw new Exceptions.API.BadParameterException("The user id is not valid. It is not allowed to be null, empty or filled with whitespaces."); }
                return await Api.GetGenericAsync<Models.API.v5.Users.UserEmotes>($"https://api.twitch.tv/kraken/users/{userId}/emotes", null, authToken).ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Subscriptions.Subscription> CheckUserSubscriptionByChannelAsync(string userId, string channelId, string authToken = null)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Subscriptions.Subscription>($"https://api.twitch.tv/kraken/users/{userId}/subscriptions/{channelId}", null, authToken).ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Users.UserFollows> GetUserFollowsAsync(string userId, int? limit = null, int? offset = null, string direction = null, string sortby = null)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Users.UserFollows>($"https://api.twitch.tv/kraken/users/{userId}/follows/channels", getParams).ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Users.UserFollow> CheckUserFollowsByChannelAsync(string userId, string channelId)
            {
                if (string.IsNullOrWhiteSpace(userId)) { throw new Exceptions.API.BadParameterException("The user id is not valid. It is not allowed to be null, empty or filled with whitespaces."); }
                if (string.IsNullOrWhiteSpace(channelId)) { throw new Exceptions.API.BadParameterException("The channel id is not valid. It is not allowed to be null, empty or filled with whitespaces."); }
                return await Api.GetGenericAsync<Models.API.v5.Users.UserFollow>($"https://api.twitch.tv/kraken/users/{userId}/follows/channels/{channelId}").ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<bool> UserFollowsChannelAsync(string userId, string channelId)
            {
                ...
                try
                {
                    await Api.GetGenericAsync<Models.API.v5.Users.UserFollow>($"https://api.twitch.tv/kraken/users/{userId}/follows/channels/{channelId}").ConfigureAwait(false);
                    return true;
                }
            ...
            public async Task<Models.API.v5.Users.UserFollow> FollowChannelAsync(string userId, string channelId, bool? notifications = null, string authToken = null)
            {
                ...
                return await Api.PutGenericAsync<Models.API.v5.Users.UserFollow>($"https://api.twitch.tv/kraken/users/{userId}/follows/channels/{channelId}", optionalRequestBody, null, authToken).ConfigureAwait(false);
            }
            #endregion
            ...
            public async Task<Models.API.v5.Users.UserBlocks> GetUserBlockListAsync(string userId, int? limit = null, int? offset = null, string authToken = null)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Users.UserBlocks>($"https://api.twitch.tv/kraken/users/{userId}/blocks", getParams, authToken).ConfigureAwait(false);
            }
            #endregion
            #region BlockUser
            public async Task<Models.API.v5.Users.UserBlock> BlockUserAsync(string sourceUserId, string targetUserId, string authToken = null)
            {
                ...
                return await Api.PutGenericAsync<Models.API.v5.Users.UserBlock>($"https://api.twitch.tv/kraken/users/{sourceUserId}/blocks/{targetUserId}", null, null, authToken).ConfigureAwait(false);
            }
            #endregion
            #region UnblockUser
            ...
            {
                Api.Settings.DynamicScopeValidation(AuthScopes.User_Read, authToken);
                return await Api.GetGenericAsync<Models.API.v5.ViewerHeartbeatService.VHSConnectionCheck>("https://api.twitch.tv/kraken/user/vhs", null, authToken).ConfigureAwait(false);
            }
            #endregion
