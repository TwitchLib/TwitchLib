...
/// </summary>
public class ChannelPointsCustomRewardRedemptionUpdate : NotificationHandler, INotificationHandler
{
    /// <inheritdoc />
    public string SubscriptionType => "channel.channel_points_custom_reward_redemption.update";

    private const string EVENT_NAME = "ChannelPointsCustomRewardRedemptionUpdate";
