    ...
    public class Channels
    {
        ...
        public class V5 : ApiSection
        {
            ...
            public async Task SetChannelCommunitiesAsync(string channelId, List<string> communityIds, string authToken = null)
            {
                ...
                await Api.PutAsync($"https://api.twitch.tv/kraken/channels/{channelId}/communities", string.Format("{\"community_ids\":[{0}]}", string.Join(",", communityIds)), authToken, ApiVersion.v5).ConfigureAwait(false);
            }
            #endregion
