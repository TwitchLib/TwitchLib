    ...
    public class Badges
    {
        ...
        public class V5 : ApiSection
        {
            ...
            public async Task<Models.API.v5.Badges.ChannelDisplayBadges> GetSubscriberBadgesForChannelAsync(string channelId)
            {
                ...
                return await Api.GetGenericAsync<Models.API.v5.Badges.ChannelDisplayBadges>($"https://badges.twitch.tv/v1/badges/channels/{channelId}/display", null, null, ApiVersion.v5).ConfigureAwait(false);
            }
            #endregion
            ...
            {
                return await Api.GetGenericAsync<Models.API.v5.Badges.GlobalBadgesResponse>("https://badges.twitch.tv/v1/badges/global/display", null, null, ApiVersion.v5).ConfigureAwait(false);
            }
            #endregion
        }
    }
