...
/// </summary>
public class ChannelPointsCustomRewardUpdateHandler : NotificationHandler, INotificationHandler
{
    /// <inheritdoc />
    public string SubscriptionType => "channel.channel_points_custom_reward.update";

    private const string EVENT_NAME = "ChannelPointsCustomRewardUpdate";
